...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.MPDS = CN()
    cfg.TRAINER.MPDS.K = 12
    cfg.TRAINER.MPDS.USE_CONTRAST = False
    cfg.TRAINER.MPDS.N_CTX = 4
    cfg.TRAINER.MPDS.CSC = False
    cfg.TRAINER.MPDS.CTX_INIT = ''
    cfg.TRAINER.MPDS.PREC = 'fp16'
    cfg.TRAINER.MPDS.CLASS_TOKEN_POSITION = ''

    cfg.TRAINER.PMP = CN()
    cfg.TRAINER.PMP.K = 12
    cfg.TRAINER.PMP.USE_CONTRAST = False
    cfg.TRAINER.PMP.CTX_INIT = ''
    cfg.TRAINER.PMP.PREC = 'fp16'
